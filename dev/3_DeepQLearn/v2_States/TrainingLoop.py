...
def train_dqn(
    ...
    for training_step in range(1, num_training_steps + 1):
        ...
        if random.random() < epsilon:
            ...
            with torch.no_grad():
                action_q_values = online_network(state.unsqueeze(0))
        ...
        if len(replay_buffer) >= batch_size:
            ...
            state_batch = torch.stack(sampled_states)
            ...
            # Predict the Q-value of every sampled action.
            ...
            if training_step % 10 == 0:
                with torch.no_grad():
                    checkpoint_q_values = online_network(state.unsqueeze(0))
